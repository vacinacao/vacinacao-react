  ...
  render() {
    return (
      <div className="About">
        ...
        <div className="Video">
        <iframe width="100%" height="400px" src="https://www.youtube.com/embed/cSG3-7IF4Gc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      </div>
    );
  }
